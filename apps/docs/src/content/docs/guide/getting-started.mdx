...
If you prefer a single object config, `createTrigger({ id, events, required, handler })` is fully supported and won't be removed before v1.0. The builder above is the new recommended path for v0.10+.
</Aside>
