...
Triggery is pre-1.0 — the public API is stabilising fast. The runtime has been used in production for orchestration since early 2026 and the test coverage targets are enforced in CI (lines ≥ 95%, branches ≥ 85%). See the [public roadmap](https://github.com/triggeryjs/triggery/blob/main/ROADMAP.md) for what's next.
