...
description: "React StrictMode дважды вызывает useEffect, чтобы выявить баги в cleanup. Стек last-mount-wins у Triggery безопасен по построению — а двойные dev-рендеры Solid и Vue ведут себя так же."
---
