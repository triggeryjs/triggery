...
<CardGrid>
  ...
  <LinkCard title="Владение" description="Почему регистрации условий / действий устроены по last-write-wins и как собирать значения из нескольких источников." href="/ru/guide/architecture/ownership/" />
</CardGrid>
