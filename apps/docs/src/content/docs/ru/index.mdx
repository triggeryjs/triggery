...
<div class="hero-cta">
  ...
  <LinkButton href={`${base}discord/`} variant="minimal" icon="external">
    Discord-чат
  </LinkButton>
</div>
...
<LinkButton
  href="https://codesandbox.io/p/github/triggeryjs/triggery/main/examples/vite-react-counter"
  variant="minimal"
  icon="external"
>
...
Triggery находится в окне 0.9.x release candidate — заморозка фич, последний круг сообщественного тестирования перед 1.0. Рантайм уже работает в продакшене с начала 2026 года, в CI закреплены пороги покрытия (строки ≥ 95%, ветви ≥ 85%). Что дальше — смотри в [публичной дорожной карте](https://github.com/triggeryjs/triggery/blob/main/ROADMAP.md).
