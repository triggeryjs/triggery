...
<CardGrid>
  ...
  <LinkCard title="Ownership" description="Why condition / action registrations are last-write-wins, and how to compose values from several sources." href="/guide/architecture/ownership/" />
</CardGrid>
